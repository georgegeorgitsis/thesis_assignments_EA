...
class Superadmin extends MY_Controller {
    ...
    public function dpt_management() {
        ...
        $crud->set_relation('key', 'keys', 'key');
    ...
    public function dpt_administrator_management() {
        ...
        $crud->fields('uacc_group_fk', 'uacc_email', 'uacc_username', 'uacc_password', 'uacc_active', 'uacc_suspend', 'department_id');
    ...
    public function custom_user_insert_callback($post) {
        return $this->flexi_auth->insert_user($this->input->post('uacc_email'), $this->input->post('uacc_email'), $this->input->post('uacc_password'), array('department_id' => $this->input->post('department_id')), $this->input->post('uacc_group_fk'), 1);
    }
